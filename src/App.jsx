...
import { PublicAttendanceCheckIn } from './components/pastor/GreatnessDashboard';
...
function AppContent() {
  ...
  const isPublicCheckIn = new URLSearchParams(window.location.search).get('checkin') === '1';
  ...
  }, [isAuthenticated, isPublicCheckIn]);
  ...
  if (isPublicCheckIn) {
    return <PublicAttendanceCheckIn />;
  }
